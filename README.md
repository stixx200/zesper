...
This project uses dotenv to set environment variables for the application. This file is not versioned in the repository so you have to create it on your own. The following envrionment variables are used so far:
